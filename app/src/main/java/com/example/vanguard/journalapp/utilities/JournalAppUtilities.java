package com.example.vanguard.journalapp.utilities;
...
public class JournalAppUtilities {
    ...
    public static String getFriendlyDateString(Context context, long normalizedUtcMidnight, boolean showFullDate) {
        ...
        if (daysFromEpochToProvidedDate == daysFromEpochToToday || showFullDate) {
            ...
            if (daysFromEpochToProvidedDate - daysFromEpochToToday < 2) {
                 ...
                 */
                @SuppressLint("SimpleDateFormat") String localizedDayName = new SimpleDateFormat("H:mm").format(localDate);
    ...
    private static String getDayName(Context context, long dateInMillis) {
        ...
        switch (daysAfterToday) {
            ...
            default:
                @SuppressLint("SimpleDateFormat") SimpleDateFormat dayFormat = new SimpleDateFormat("EEE, d MMM yyyy");
